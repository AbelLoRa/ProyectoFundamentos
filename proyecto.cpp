...
Conversiones::decimalHexadecimal(){
	...
	cout<<"\n\n\tEl número "<<numero<<" en hexadecimal es: ";
...
cifras(int numero, int base){
	...
	if(verif == 1){
		...
		if(base == 8){
			cout<<"\n\n\tEl número "<<numO<<" en octal es: ";
			if(numO < 0){
				cout<<"-";
			}
			funcionConvertir(8, suma);
		}else if(base == 16){
			cout<<"\n\n\tEl número "<<numO<<" en hexadecimal es: ";
			if(numO < 0){
				cout<<"-";
			}
			funcionConvertir(16, suma);
		}else if(base == 2){
			cout<<"\n\n\tEl número "<<numO<<" en decimal es: ";
			if(numO < 0){
				cout<<"-";
			}	
			cout<<suma;
...
void funcionPalomar(int numero, int numero1){
	...
	if(numero < 1 || numero1 < 1){
		cout << "\n\n\tERROR, el número 0 y negativos no son válidos, vuelve a intentarlo.";
...
void imprimirFactorialConMultiplicacion(int num) {
	...
	cout << "\n\n\tLa permutación ordinaria es de: \n";
    cout << "\n\n\t"<< num << "! = ";
    for (int i = num; i > 0; --i) {
        cout << i;
        if (i > 1) {
...
opcionesConversion(int op){
	...
	switch(op){
		...
		case 2:{
			system("cls");
			titulos(2);
			cout<<"\n\n\tIngresa el número para convertir a Binario: ";
			cin>>numero;
			Conversiones opcion(numero);			
		...
		case 3:{
			system("cls");
			titulos(3);
			cout<<"\n\n\tIngresa el número para convertir a octal: ";
			cin>>numero;
			Conversiones opcion(numero);			
			opcion.decimalOctal();
			cout<<endl;
		...
		case 5:{
			system("cls");
			titulos(5);
			cout<<"\n\n\tIngresa un número en binario para convertir a decimal: ";
			cin>>numero;
			Conversiones opcion(numero);			
		...
		case 6:{
			system("cls");
			titulos(6);
			cout<<"\n\n\tIngresa un número para convertir a Octal: ";
			cin>>numero;
			Conversiones opcion(numero);			
			opcion.binarioOctal();
			cout<<endl;
		...
		case 7:{
			system("cls");
			titulos(7);
			cout<<"\n\n\tIngresa un número para convertir a hexadecimal: ";
			cin>>numero;
			Conversiones opcion(numero);			
...
opcionesCombinatoria(int op){
	...
	switch(op){
		...
		case 3:{
			system("cls");
			titulos(10);
			cout<<"\n\n\tIngresa el número de palomas: ";
			cin>>numero;
			cout<<"\n\n\tIngresa el número de palomares: ";
			cin>>numero1;
			Combinatoria opcion(numero, numero1);			
			opcion.palomar();
			cout<<endl;
...
//Función principal
main(){
	system("mode con: cols=150 lines=50"); //Se define el tamaño de la consola 
	system("color 70");
	setlocale(LC_ALL, "");
	int op;
	do{ 
